...
const (
	Auth_Login_FullMethodName    = "/api.v1.public.auth.Auth/Login"
	Auth_Register_FullMethodName = "/api.v1.public.auth.Auth/Register"
)
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.public.auth.Auth",
