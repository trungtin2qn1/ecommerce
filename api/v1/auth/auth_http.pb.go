...
const OperationAuthLogin = "/api.v1.public.auth.Auth/Login"
const OperationAuthRegister = "/api.v1.public.auth.Auth/Register"
...
func RegisterAuthHTTPServer(s *http.Server, srv AuthHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/public/login", _Auth_Login0_HTTP_Handler(srv))
	r.POST("/v1/public/register", _Auth_Register0_HTTP_Handler(srv))
}
